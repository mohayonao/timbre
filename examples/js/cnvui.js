...
var CnvUI = (function() {
    ...
    WIDGETS["label"] = (function() {
        ...
        $this.draw = function() {
            ...
            switch (this.align) {
            case "center":
                w = context.measureText(this.value).width;
                context.fillText(this.value, this.x - (w/2), this.y+10);
                break;
            case "right":
                w = context.measureText(this.value).width;
                context.fillText(this.value, this.x - w, this.y+10);
                break
            case "left":
            default:
                context.fillText(this.value, this.x, this.y+10);
                break;
            }
            context.restore();
        };
