...
var GreaterThanEql = (function() {
    var GreaterThanEql = function() {
        initialize.apply(this, arguments);
    }, $this = GreaterThanEql.prototype;
    ...
    return GreaterThanEql;
}());
timbre.fn.register(">=", GreaterThanEql);

// __END__
if (module.parent && !module.parent.parent) {
    describe("lessthan", function() {
        object_test(GreaterThanEql, ">=");
        describe("#seq()", function() {
            ...
            it("ar-mode", function() {
                ...
                instance.seq(0).should.eql(
                    new Float32Array([0,0,0,0,0,1,1,0])
                );
            });
            it("kr-mode", function() {
